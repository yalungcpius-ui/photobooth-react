        ...
        <div className="integration-card">
          ...
          {selectedProfile ? <>
            ...
            <div className="settings-grid three-columns">
              ...
              <label className="field-group">Orientation<select value={selectedProfile.orientation} onChange={(event) => updateSelectedProfile({ orientation: event.target.value as PrinterProfile['orientation'] })}><option value="portrait">Portrait</option><option value="landscape">Landscape</option></select></label>
